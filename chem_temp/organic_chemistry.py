...
def qa_h(h20mass,compound_mass_taken):
    return (2/18)*(h20mass/compound_mass_taken)*100

def qa_n(voln2,compound_mass_taken):
    return (28/22400)* (voln2/compound_mass_taken)*100

def qa_n_kjeldahl(molarity_acid,vol_acid_used,basicity_acid,compound_mass_taken):
    return (1.4*molarity_acid*vol_acid_used*basicity_acid)/compound_mass_taken

def qa_x(at_mass_x,mass_agx_formed,compound_mass_taken):
